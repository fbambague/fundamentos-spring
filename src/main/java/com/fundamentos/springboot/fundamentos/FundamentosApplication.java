...
//		userRepository.saveAll(users);
	...
	private void saveWithErrorTransactional(){
		...
		User test1 = new User("leo"
				,"test@mail.com"
				, LocalDate.now());
		User test2 = new User("cris"
				,"test2@mail.com"
				, LocalDate.now());
		User test3 = new User("alison"
				,"test3@mail.com"
				, LocalDate.now());
		User test4 = new User("moh"
				,"test@mail.com"
				, LocalDate.now());
		User test5 = new User("kylli"
				,"test5@mail.com"
				, LocalDate.now());
		User test6 = new User("cris2"
				,"test6@mail.com"
				, LocalDate.now());
		List<User> users = Arrays.asList(test1,test2,test3,test4,test5,test6);

		try{
			userService.saveTransactional(users);
		}catch (Exception e){
			LOGGER.error("Excepción generated by trasactional method: "+e);
		}

	userService.getAllUsers()
			.stream()
			.forEach(user -> LOGGER.info("User found by transactional method: "+user));
